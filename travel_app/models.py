...
class TravelPackage(models.Model):
    slug = models.SlugField('套餐编号', max_length=120, unique=True)
    ...
    image_url = models.URLField('图片链接', max_length=600, blank=True)
    fallback_image = models.CharField('备用图片', max_length=200, blank=True, default='images/packages/p1.jpg')
    ...
    highlights = models.TextField('亮点', blank=True, default='')
    rating = models.PositiveSmallIntegerField('评分', default=5)
    reviews = models.PositiveIntegerField('评价数', default=0)
    is_featured = models.BooleanField('首页展示', default=True)
